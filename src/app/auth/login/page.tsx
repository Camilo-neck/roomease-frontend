		...
		<div className="flex flex-col items-center w-full">
			<div className="flex flex-col w-full items-center px-36">
				...
				<form id='loginForm' ref={formRef} className="flex flex-col self-center items-center w-full my-5 px-24 gap-5" onSubmit={handleSubmit(onSubmit)}>
					...
					<TextField error={errors.pass ? true : false} helperText={errors.pass ? `${errors.pass?.message}`: ''} className='w-96 lg:w-[35rem]' type='password' label="Contraseña" variant='standard' {...register('pass', {required: "Debe ingresar su contraseña", minLength: 8})} />
				</form>
				<Button 
