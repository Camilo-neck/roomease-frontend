		...
		<Card className="shadow-lg rounded-lg" sx={{ maxWidth: 345 }}>
			...
			<CardContent>
				...
				<Typography
					...
					className="text-xs text-center line-clamp-1 hover:line-clamp-none transition-all duration-300  text-primary-40 font-mono cursor-pointer hover:text-primary-50 active:text-primary-30"
					gutterBottom
					component="div"
				>
				...
				<Typography className="text-sm text-center line-clamp-1 hove:line-clamp-none transition-all duration-300 " gutterBottom component="div" color="text.secondary">
					{address}
				</Typography>
				<Typography className="line-clamp-3 hover:line-clamp-none  transition-all duration-300 leading-5 text-sm">{description}</Typography>
			</CardContent>
			{isOwner ? (
