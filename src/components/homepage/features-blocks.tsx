				...
				<div className="py-12 md:py-20">
					...
					<div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
						...
						<div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
							...
							<h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Organización sin esfuerzo:</h4>
							<p className="text-gray-600 text-center">Crea y gestiona tareas sin sudar la gota gorda.</p>
						</div>
						...
						<div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
							...
							<h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Colaboración en equipo:</h4>
							<p className="text-gray-600 text-center">Trabaja en equipo para un hogar más feliz.</p>
						</div>
						...
						<div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
							...
							<h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Flexibilidad personalizada:</h4>
							<p className="text-gray-600 text-center">Ajusta las tareas a tu horario y estilo de vida.</p>
						</div>
						...
						<div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
							...
							<h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Ahorro de tiempo y energía:</h4>
							<p className="text-gray-600 text-center">Dedica más tiempo a lo que realmente importa.</p>
						</div>
					</div>
				</div>
			</div>
